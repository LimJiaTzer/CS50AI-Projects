...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        while changes_made:
            ...
            # Mark new mines and safes and update the sentences
            ...
            if not changes_made:
                ...
                for i, s1 in enumerate(self.knowledge):
                    for j, s2 in enumerate(self.knowledge):
                        if i != j and s1.cells and s2.cells:
                            if s1.cells.issubset(s2.cells) and s1.cells != s2.cells:
                                ...
                                if diff_cells:
                                    ...
                                    if all(new_sentence != existing for existing in self.knowledge + new_sentences):
    ...
    def make_random_move(self):
        ...
        """
        # Precompute all possible moves for efficiency
        ...
        return random.choice(list(all_possible_moves)) if all_possible_moves else None
